...
from optimum.habana.diffusers import GaudiStableDiffusionZImageControlNetPipeline
...
def main():
    ...
    for i in range(args.loop):
        ...
        t1 = time.time()
        duration = t1 - t0
        print("Z-Image Controlnet Pipeline Latency in Loop #{:d}: {:.1f} sec".format(i, duration))
    file_name = f"z_image_controlnet_output_{args.width}x{args.height}.png"
