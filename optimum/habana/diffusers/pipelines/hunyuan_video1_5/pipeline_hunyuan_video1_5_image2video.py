...
from ...models.attention_processor import AttnProcessor2_0, GaudiHunyuanVideo15AttnProcessor2_0
from ...models.autoencoders.autoencoder_kl_hunyuanvideo15 import (
    ...
    HunyuanVideo15CausalConv3dForwardGaudi,
...
class GaudiHunyuanVideo15ImageToVideoPipeline(GaudiDiffusionPipeline,HunyuanVideo15ImageToVideoPipeline):
    ...
    def __init__(
        ...
        self.vae.decoder.conv_in.forward = types.MethodType(HunyuanVideo15CausalConv3dForwardGaudi, self.vae.decoder.conv_in)
        self.vae.decoder.conv_out.forward = types.MethodType(HunyuanVideo15CausalConv3dForwardGaudi, self.vae.decoder.conv_out)
        for attn in self.vae.decoder.mid_block.attentions:
            attn.forward = types.MethodType(HunyuanVideo15AttnBlockForwardGaudi, attn)
        for resnet in self.vae.decoder.mid_block.resnets:
            resnet.conv1.forward = types.MethodType(HunyuanVideo15CausalConv3dForwardGaudi,resnet.conv1)
        ...
        for block in self.vae.decoder.up_blocks:
            ...
            if block.upsamplers is not None:
                for upsampler in block.upsamplers:
                    upsampler.conv.forward = types.MethodType(HunyuanVideo15CausalConv3dForwardGaudi, upsampler.conv)
