...
class GaudiLlamaAttention(LlamaAttention):
    ...
    def pre_attn_forward(
        ...
        use_llama_rope: Optional[bool] = False,
        ...
        query_states, key_states = apply_customized_rope(
            query_states, key_states, cos, sin, position_ids, use_llama_rope=use_llama_rope
        )
...
def apply_customized_rope(q, k, cos, sin, position_ids, use_llama_rope=False):
    if q.device.type == "hpu" and FusedRoPE and not use_llama_rope:
